"""Logging utilities for dbt-llm-agent."""
...
DEFAULT_LOG_FILE = "~/.dbt-llm-agent/logs/dbt-llm-agent.log"
...
def setup_logging(log_level: str = None, log_file: str = None) -> None:
    ...
    log_file = log_file or os.environ.get("DBT_LLM_AGENT_LOG_FILE", DEFAULT_LOG_FILE)
