...
def upgrade() -> None:
    """Upgrade schema."""
    logger.info(f"Starting Add can_be_used_for_answers to model_embeddings upgrade")
    ...
    logger.info(f"Completed Add can_be_used_for_answers to model_embeddings upgrade")


def downgrade() -> None:
    """Downgrade schema."""
    logger.info(f"Starting Add can_be_used_for_answers to model_embeddings downgrade")
    ...
    logger.info(f"Completed Add can_be_used_for_answers to model_embeddings downgrade")
